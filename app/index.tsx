...
import { ACCENT, ACCENT_DIM, BG, BORDER, SECONDARY } from '@/lib/theme'
import { APP_NAME, APP_TAGLINE, APP_DESCRIPTION } from '@/lib/constants'

const { width: SW, height: SH } = Dimensions.get('window')

const FEATURES = [
  { icon: 'sparkles' as const, title: 'AI Beauty Filters', desc: 'One-tap skin smoothing & makeup' },
  { icon: 'image-outline' as const, title: 'Background Swap', desc: 'Remove & replace any background' },
  { icon: 'videocam-outline' as const, title: 'Video Editor', desc: 'Trim, effects & viral content' },
]
        ...
        <View style={s.headerBar}>
          <View style={s.headerLeft}>
            <LinearGradient
              ...
              style={s.headerLogo}
            >
              <Text style={s.headerLogoText}>G</Text>
            </LinearGradient>
...
const s = StyleSheet.create({
  ...
  headerLogo: { width: 36, height: 36, borderRadius: 999, alignItems: 'center', justifyContent: 'center' },
  headerLogoText: { fontSize: 16, fontWeight: '800', color: '#fff' },
  ...
  heroDesc: { color: 'rgba(255,255,255,0.48)', fontSize: 14, lineHeight: 21, maxWidth: 320, marginTop: 2 },
  featuresWrap: { flex: 1, justifyContent: 'center', paddingHorizontal: 24, gap: 14 },
  featureRow: {
    flexDirection: 'row', alignItems: 'center', gap: 14,
    backgroundColor: 'rgba(255,255,255,0.04)', borderWidth: 1,
    borderColor: BORDER, borderRadius: 14, paddingVertical: 14, paddingHorizontal: 16,
  },
  featureIconWrap: {
    width: 38, height: 38, borderRadius: 11, backgroundColor: ACCENT_DIM,
  ...
  legal: { color: 'rgba(255,255,255,0.22)', textAlign: 'center', fontSize: 11, lineHeight: 17, paddingHorizontal: 8 },
  legalLink: { color: 'rgba(255,255,255,0.38)', textDecorationLine: 'underline' },
})
