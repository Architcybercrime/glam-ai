                    ...
                    <View style={{ flex: 1, backgroundColor: BG }}>
                      <Stack ref={navigationRef} screenOptions={{ headerShown: false, animation: 'fade', contentStyle: { backgroundColor: BG } }}>
                        ...
                        <Stack.Protected guard={!!isAuthed && onboardingCompleted === true}>
                          ...
                          <Stack.Screen name="beauty" options={{ animation: 'slide_from_bottom' }} />
                          <Stack.Screen name="background" options={{ animation: 'slide_from_bottom' }} />
                          <Stack.Screen name="video-editor" options={{ animation: 'slide_from_bottom' }} />
